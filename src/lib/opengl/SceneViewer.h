...
class SceneViewer : public glfw_KeyListener
{
   public:
    ...
    float rot_angle             = 0.f;
    bool use_crop_for_rendering = true;
    ...
    ImageInfo CurrentFrameData() const
    {
        ...
        {
            // fd.w                 = default_pinhole.cx * 2;  // * scene->dataset_params.render_scale;
            // fd.h                 = default_pinhole.cy * 2;  // * scene->dataset_params.render_scale;
